...
// counter left
var timeSpentinlvl2 = +localStorage.getItem('there1');
var minutesChyata = Math.floor(timeSpentinlvl2 / 60000);
var secondsChyata = +((timeSpentinlvl2 % 60000) / 1000).toFixed(0);
// timer :
function countdown() {
...
var storeIncOptions = optionsShuffler(myJson[2].niv3[currentIndex].incorrect_answers);
//   No need to shufle since it's only one value there
var storeCoOptions = (myJson[2].niv3[currentIndex].correct_answer);
//debug
...
next.addEventListener("click", function () {
    ...
    if (currentIndex < 4) {
        ...
        b_1.textContent = myJson[2].niv3[currentIndex].question;
        question_1.innerHTML = '';
        question_1.appendChild(b_1);
        // Les options : 
        // Shuffling values that exists in the json 
        var storeIncOptions_1 = optionsShuffler(myJson[2].niv3[currentIndex].incorrect_answers);
        //   No need to shufle since it's only one value there
        var storeCoOptions_1 = (myJson[2].niv3[currentIndex].correct_answer);
        //debug
